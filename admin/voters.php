                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      echo "
                        <tr>
                          ...
                          <td>".$row['voters_id']."</td>
                          <td>".$row['phone']."</td>
                          <td>".unserialize($row['meta'])['district_name']." - ".unserialize($row['meta'])['ward_name']." </td>
                          <td>
...
$('#ward-district').change(function(){
  var districtTitle = $('#select-district option:selected').data('district-title');
  var wardTitle = $('#ward-district option:selected').data('ward');
  $('[name="district-name"]').val(districtTitle);
  $('[name="ward-name"]').val(wardTitle);
