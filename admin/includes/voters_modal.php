        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="votarId" class="col-sm-3 control-label">Id</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="votarId" name="votarId" required>
                    </div>
                </div>

                <div class="form-group">
                    <label for="select-district" class="col-sm-3 control-label">State</label>
                ...
                <div class="form-group">
                    <label for="ward-district" class="col-sm-3 control-label">Area</label>

                    <div class="col-sm-9">
                      <select name="ward-district" id="ward-district" class="col-sm-12 form-select form-select-sm" aria-label=".form-select-sm">
                ...
                <input type="text" name="ward-name" hidden>
                <input type="text" name="district-name" hidden>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="voters_edit.php">
                ...
                <div class="form-group">
                    <label for="edit_voters_id" class="col-sm-3 control-label">ID</label>
