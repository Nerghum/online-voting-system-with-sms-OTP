<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class=""><a href="election.php"><i class="fa fa-check"></i><span>Election</span></a></li>
      <li class=""><a href="voters.php"><i class="fa fa-users"></i> <span>Voters</span></a></li>
      <li class=""><a href="positions.php"><i class="fa fa-tasks"></i> <span>Positions</span></a>
      <li class=""><a href="area.php"><i class="fa fa-map-signs"></i> <span>Area</span></a></li>
      </li>
